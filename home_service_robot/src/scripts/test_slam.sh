...
xterm -e "cd "$workspace_path" && source devel/setup.bash && roslaunch gmapping slam_gmapping_tapan.launch" &
...
xterm -e "cd "$workspace_path" && source devel/setup.bash && roslaunch teleop_twist_keyboard teleop.launch"
